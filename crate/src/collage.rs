...
pub fn four_grid_text(mut photon_img: PhotonImage, photon_img2: PhotonImage, width: u32, height: u32) -> PhotonImage {
    ...
    photon_img.draw_solid_rect(&yellow, img_height, img_width, image.width() as i32, 0);
    photon_img.draw_solid_rect(&lilac, img_height, img_width, 0, image.height() as i32);
...
/// Add text to an image.
#[wasm_bindgen]
pub fn collage_test(mut photon_img: PhotonImage, width: u32, height: u32) -> PhotonImage {
    let image = helpers::dyn_image_from_raw(&photon_img);
...
pub fn split_imgs_text(photon_img: PhotonImage, photon_img2: PhotonImage, width: u32, height: u32) -> PhotonImage {
    ...
    let lilac = Rgb{r: 204, g: 195, b: 240};
    let yellow = Rgb{ r: 255, g: 226, b: 98};
    photon_img.draw_solid_rect(&white, img_height * 2, img_width, 0, 0);
    photon_img.draw_text("Life Is An Adventure", 45, img_height / 2, "Roboto-Bold", 30.0);
...
/// Add text to an image.
#[wasm_bindgen]
pub fn four_grid(mut photon_img: PhotonImage, photon_img2: PhotonImage, photon_img3: PhotonImage, photon_img4: PhotonImage, width: u32, height: u32) -> PhotonImage {
    let image = helpers::dyn_image_from_raw(&photon_img);
    let image2 = helpers::dyn_image_from_raw(&photon_img2);
