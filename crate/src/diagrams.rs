...
use crate::elements::{draw_preset_rect_gradient, draw_solid_rect};
    ...
    for item in &barchart.data {
        ...
        if chart_type == "histogram" {
            draw_line_segment_mut(
                ...
                ((start_x + bar_width as i32) as f32, start_y as f32),
